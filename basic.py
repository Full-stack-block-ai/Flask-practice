...
class InfoForm(FlaskForm):
    ...
    mood = RadioField('please choose mood:', choices=[('mood_one', 'Happy'), ('mood_two','Excited')])
    food_choice = SelectField('pick your favourite food:', choices=[('chi','Chicken'), ('bf','beef')])
